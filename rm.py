...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  4 22:14:28 2017
@author: lihaoruo
...
class Memory(object):  # stored as ( s, a, r, s_ ) in SumTree
    ...
    def sample(self, n):
        #print('1561613216548615311841315648489646',self.tree.data[-1])
        ...
        #print('--------------------------n-------------------------', n)
        state_est, state, action, Q_target = [], [], [], []
        for i in range(n):
            ...
            b_idx[i] = idx
            state_est.append(data[0])
            state.append(data[1])
            action.append(data[2])
            Q_target.append(data[3])
        b_memory = [state_est, state, action, Q_target]
